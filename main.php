...
function printBanner() {
    ...
    $banner = "
-------------------------------------------------
    Jockey Earning must Join For More Script Loot If Facing Error Contact On Telegram 
-------------------------------------------------

     - NOT PIXEL VIP SCRIPT -
     - 100% ANTI-BAN -
     
- CREATE BY : JockeyEarning
- Telegram: @JockeyEarning
- channel: https://t.me/JockeyEarning
    ...
    foreach ($users as $userId => $userData) {
        ...
        if ($httpCode === 200) {
            ...
            if ($reward) {
                ...
                echo printColored("[ REPORT ] If facing issue again and again Send Details and ScreenShot Contact Developer Telegram @JockeyEarning\n", $yellow);
                continue;
            }
        } elseif ($httpCode === 403) {
